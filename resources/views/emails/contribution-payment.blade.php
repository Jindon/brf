...
<table
    ...
    <tr>
        <td colspan="2" style="font-size:14px;padding:50px 15px 0 15px;">
            <strong style="display:block;margin:0 0 10px 0;">Dear</strong> {{ $patronName }}<br> You have the following pending payments.<br><br>
    ...
    <tr>
        <td colspan="2" style="font-size:20px;padding:30px 15px 0 15px;">Pending Payments</td>
    </tr>
    <tr>
        <td colspan="2" style="padding:15px;">
            @foreach($duePayments as $index=>$duePayment)
                <p style="font-size:14px;margin:0;padding:10px;border:solid 1px #ddd;font-weight:bold;">
                    ...
                    <b style="font-size:12px;font-weight:300;"> Due amount:</b> ₹{{ $duePayment->due }} <b style="font-size:12px;font-weight:300;"> | Fine:</b> ₹{{ $duePayment->fine }}
                </p>
            @endforeach
